...
<?php
if($mode!='single'){
echo'<script type="text/javascript" src="theme/alpha/js/velocity.min.js"></script>
<script id="tabby" type="text/javascript" src="theme/alpha/js/tabtab.js"></script>
<script>
var tabs = jQuery.noConflict();
if ( tabs(window).width() > 739) {
var test = tabs(window).width();
tabs(".page").css("width", test);
tabs("#tabs").tabtab({
    tabMenu: ".menu",                   // direct container of the tab menu items
    tabContent: ".tabs-container",      // direct container of the tab content items
    ...
    easing: "swing",           // http://julian.com/research/velocity/#easing
    ';
    if($mode=='fade'){echo'slideDelay: 300,                      // delay the animation  ';}
    if($mode=='vertical'){echo'translateY: "slide",     // animate along the Y axis (val: px or ‘slide’)';}
    if($mode=='horizontal'){echo'translateX: "slide",   // animate along the X axis (val: px or ‘slide’)';}
   echo'
...
echo'<script type="text/javascript" src="theme/alpha/js/jquery.nav.js"></script>
<script>
